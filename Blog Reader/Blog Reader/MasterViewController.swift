...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/3764380634374269600/posts?key=AIzaSyBXy630vn6kmSpH7QUZsgQqQ72WRvyHoA4") {
                    ...
                    if let urlData = data {
                        ...
                        do {
                            ...
                            if let items = jsonResult["items"] as? NSArray {
                                ...
                                // Remove all the data already inside
                                ...
                                for item_dict in items {
                                    if let item = item_dict as? NSDictionary {
...
//        }
    ...
    func configureCell(_ cell: UITableViewCell, withEvent event: Event) {
        cell.textLabel!.text = (event.value(forKey: "title") as? String)?.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines)
    }
